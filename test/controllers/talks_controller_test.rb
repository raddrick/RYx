...
class TalksControllerTest < ActionController::TestCase
  ...
  test "should create talk" do
    assert_difference('Talk.count') do
      post :create, talk: { description: @talk.description, speaker_id: @talk.speaker_id, title: @talk.title, video: @talk.video }
    end
  ...
  test "should update talk" do
    patch :update, id: @talk, talk: { description: @talk.description, speaker_id: @talk.speaker_id, title: @talk.title, video: @talk.video }
    assert_redirected_to talk_path(assigns(:talk))
  end
