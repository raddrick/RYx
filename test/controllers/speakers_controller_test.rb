...
class SpeakersControllerTest < ActionController::TestCase
  ...
  test "should create speaker" do
    assert_difference('Speaker.count') do
      post :create, speaker: { bio: @speaker.bio, facebook: @speaker.facebook, instagram: @speaker.instagram, linkedin: @speaker.linkedin, name: @speaker.name, twitter: @speaker.twitter }
    end
  ...
  test "should update speaker" do
    patch :update, id: @speaker, speaker: { bio: @speaker.bio, facebook: @speaker.facebook, instagram: @speaker.instagram, linkedin: @speaker.linkedin, name: @speaker.name, twitter: @speaker.twitter }
    assert_redirected_to speaker_path(assigns(:speaker))
  end
